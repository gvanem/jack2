 ...
 */
JackDual_API_EXPORT jack_client_t * jack_client_open (const char *client_name,
...
*/
Jack_API_EXPORT jack_client_t * jack_client_new (const char *client_name) JACK_OPTIONAL_WEAK_DEPRECATED_EXPORT;

/**
 *
 */
JackDual_API_EXPORT jack_client_t* jack_client_new_aux (const char* client_name,
                                                        jack_options_t options,
 ...
 */
JackDual_API_EXPORT int jack_client_close (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;

/**
 * @return the maximum number of characters in a JACK client name
 * including the final NULL character.  This value is a constant.
 */
Jack_API_EXPORT int jack_client_name_size (void) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
Jack_API_EXPORT char * jack_get_client_name (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * returned value.
 */
Jack_API_EXPORT char *jack_get_uuid_for_client_name (jack_client_t *client,
 ...
 * returned value.
 */
Jack_API_EXPORT char *jack_get_client_name_by_uuid (jack_client_t *client,
 ...
 */
Jack_API_EXPORT int jack_internal_client_new (const char *client_name,
 ...
 */
Jack_API_EXPORT void jack_internal_client_close (const char *client_name) JACK_OPTIONAL_WEAK_DEPRECATED_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
Jack_API_EXPORT int jack_activate (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
Jack_API_EXPORT int jack_deactivate (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;

/**
 * @return pid of client. If not available, 0 will be returned.
 */
JackDual_API_EXPORT int jack_get_client_pid (const char *name) JACK_OPTIONAL_WEAK_EXPORT;

/**
 * @return the pthread ID of the thread running the JACK client side
 * real-time code.
 */
Jack_API_EXPORT jack_native_thread_t jack_client_thread_id (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
Jack_API_EXPORT int jack_is_realtime (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
Jack_API_EXPORT jack_nframes_t jack_thread_wait (jack_client_t *client, int status) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
Jack_API_EXPORT jack_nframes_t jack_cycle_wait (jack_client_t* client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
Jack_API_EXPORT void jack_cycle_signal (jack_client_t* client, int status) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code.
*/
Jack_API_EXPORT int jack_set_process_thread(jack_client_t* client, JackThreadCallback thread_callback, void *arg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
extern Jack_API_EXPORT void (*jack_error_callback)(const char *msg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
extern Jack_API_EXPORT void (*jack_info_callback)(const char *msg) JACK_OPTIONAL_WEAK_EXPORT;
